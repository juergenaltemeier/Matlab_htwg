...
x = data{:, 1};
y = data{:, 2};
c = polyfit(x,y,1); %Bildet ein Polynom des 1. Grades mit den Daten von x,y
m = c(1);
b = c(2);
y2 = m*x + b;
fprintf('m = %f, b = %f\n', m, b);
fprintf('Gerade: f(x) = %f * x %f\n', m, b);

scatter(x, y); %Plotten der einzelnen Punkte und der berechneten Geraden.
hold on;
plot(x, y2, 'r');
hold off;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
